...
public class DeveloperConsoleOptionTest extends BasicTest {
	
	@Test
	public void checkDeveloperConsole() throws InterruptedException, IOException {
		...
		//clicking "developer console " 3rd option
